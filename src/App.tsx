...
const LinguaRoots = lazy(() => import('./pages/projects/LinguaRoots'))
const DermaTone = lazy(() => import('./pages/projects/DermaTone'))
const Decoded = lazy(() => import('./pages/projects/Decoded'))
...
const PublicationsHonors = lazy(() => import('./components/section/PublicationsHonors'))
...
function AppContent() {
  ...
  return (
    <>
      <Navigation />
      <div className="app transition-colors duration-300" style={{ backgroundColor: isDarkMode ? '#220C0F' : undefined }}>
        ...
        <main id="main-content" className="main-content">
          <Suspense fallback={<div className="flex items-center justify-center min-h-screen">Loading...</div>}>
            <Routes>
              ...
              <Route path="/projects/linguaroots" element={<LinguaRoots />} />
              <Route path="/projects/dermatone" element={<DermaTone />} />
              <Route path="/projects/decoded" element={<Decoded />} />
            </Routes>
          </Suspense>
        </main>
