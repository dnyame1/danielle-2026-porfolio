...
const About = () => {
  ...
  const profileImages = [
    { src: profile1, caption: "UT Austin, class of 2029" },
    { src: profile2, caption: "Presenting DermaTone at HookEmHacks" },
    { src: profile3, caption: "HerStory conference" }
  ];
          ...
          <div className="flex flex-col md:flex-row justify-between items-start max-w-6xl mx-auto gap-8">
            <div className="text-left w-full md:w-auto">
              <div className="ascii-container justify-start text-3xl md:text-4xl lg:text-5xl">
                <AsciiMorphText text="Hi, I am Danielle Nyame" />
              </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex items-center justify-center relative min-h-[400px] md:min-h-[600px]">
            ...
            <div className="w-full md:max-w-2xl lg:max-w-4xl relative z-20 px-1 md:px-0">
              ...
              {/* Click to view story prompt */}
              <div
                className="flex items-center justify-center gap-2 mt-3 cursor-pointer group"
                onClick={() => setShowProfileModal(true)}
              ...
              >
                <span style={{
                  ...
                  ✦ click to read Danielle's story ✦
                </span>
              </div>
            </div>
          </div>
