...
import { comingSoon, linguarootsIcon, dermatoneIcon, decodedIcon } from '../../assets';
...
const Projects = () => {
  ...
  const projects = [
    {
      title: "LinguaRoots",
      description: "A production-ready iOS heritage language learning app for the Ghanaian diaspora. 8 screens built in SwiftUI in under 30 days — featuring personalized onboarding, interactive Twi units, flashcard notecards, gamification with XP/streaks, and an AI conversation feature.",
      technologies: ["Swift", "SwiftUI", "Python", "FastAPI", "PostgreSQL"],
      icon: linguarootsIcon,
      detailsUrl: "/projects/linguaroots",
      githubUrl: "https://github.com/dnyame1/linguaroots"
    },
    {
      title: "DermaTone",
      description: "An inclusive AI dermatology tool addressing bias in skin-condition detection. Integrates Monk Skin Tone (MST 1–10) classification across 10 skin tone categories with 6+ interactive frontend components and sub-second response times.",
      technologies: ["React", "FastAPI", "Swift"],
      icon: dermatoneIcon,
      detailsUrl: "/projects/dermatone",
      githubUrl: "https://github.com/Nanamib/HookemHacks"
    },
    {
      title: "Decoded",
      description: "🏆 2nd place at Fidelity FidHacks 2026. A financial wellness platform helping early-career professionals decode offer letters, compare compensation packages, and build long-term financial literacy through 5 core product features.",
      technologies: ["React", "TypeScript", "Vite", "HTML", "CSS"],
      icon: decodedIcon,
      detailsUrl: "/projects/decoded",
      ...
      >
        ...
        <span
          style={{
            ...
            fontSize: '26px',
            color: isDarkMode ? '#E0B287' : '#A8622F',
            fontWeight: 'bold',
            userSelect: 'none',
